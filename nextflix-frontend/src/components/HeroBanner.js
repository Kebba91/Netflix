export default function HeroBanner() {
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.85) 10%, rgba(0,0,0,0.4) 50%, rgba(0,0,0,0.85)), url('https://assets.nflxext.com/ffe/siteui/vlv3/7e7e6e6e-6e6e-4e4e-8e8e-8e8e8e8e8e8e/7e7e6e6e-6e6e-4e4e-8e8e-8e8e8e8e8e8e_PL-en-20230619-popsignuptwoweeks-perspective_alpha_website_large.jpg')`,
